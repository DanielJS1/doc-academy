 ...
 * Canvas-based and theme-aware, it idles when no ring is alive,
 * pauses off-screen and in hidden tabs, and renders a still grid
...
export const SonarGrid = React.forwardRef<HTMLDivElement, SonarGridProps>(function SonarGrid(
  ...
  React.useEffect(() => {
    ...
    let visible = true;
    let seeded = false;
    let stroke = opts.current.color || "#818cf8";
