...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return <div className="app">
    ...
    <Link href="/" className="brand" aria-label="DOC-Academy — início"><span><strong>DOC-Academy</strong><small>CONHECIMENTO QUE TRANSFORMA</small></span></Link>
      ...
      <div className="sidebar-bottom"><div className="sidebar-note"><span className="little-star"><Sparkles size={17}/></span><strong>Conhecimento abre caminhos.</strong><p>Um novo aprendizado.<br/>Uma nova possibilidade.</p><Link href="/aprender">Explore os cursos <ArrowUpRight size={16}/></Link></div><Link className="help-link" href="/sobre"><CircleHelp size={17}/> Sobre a plataforma</Link><div className="sidebar-footer"><div className="brand-block"><span className="demaria">de<span>maria</span><i/></span><img className="brand-official" src="/doc-academy-logo-oficial.png" alt="DOC-Academy logo"/></div><span>Aprender. Evoluir.</span></div></div>
    </aside>
