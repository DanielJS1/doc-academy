...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return <div className="app">
    ...
    <aside className={`sidebar ${mobileOpen ? "is-open" : ""}`} aria-label="Navegação principal">
      <Link href="/" className="brand" aria-label="DOC-Academy — início"><img className="brand-official" src="/doc-academy-logo-oficial.png" alt=""/><span><strong>DOC<span>Academy</span></strong><small>CONHECIMENTO QUE TRANSFORMA</small></span></Link>
      ...
      <div className="sidebar-bottom"><div className="sidebar-note"><span className="little-star"><Sparkles size={17}/></span><strong>Conhecimento abre caminhos.</strong><p>Um novo aprendizado.<br/>Uma nova possibilidade.</p><Link href="/aprender">Explore os cursos <ArrowUpRight size={16}/></Link></div><Link className="help-link" href="/sobre"><CircleHelp size={17}/> Sobre esta demonstração</Link><div className="sidebar-footer"><span className="demaria">de<span>maria</span><i/></span><span>Aprender. Evoluir.</span></div></div>
    </aside>
